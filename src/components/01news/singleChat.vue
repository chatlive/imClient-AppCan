...
<script>
	...
	import Singleheader from 'components/01news/singleHeader'
	import Singlemessage from 'components/01news/singleMessage'
	import Singlesendmessage from 'components/01news/singleSendMessage'
